...
var $buoop = {
  ...
  url: '/admin/upgrade-your-browser/index.html?referrer=' + encodeURIComponent(window.location.href), // 点击通知后跳转到此链接
  reminder: 0, // x小时后重复显示 // 0 = 总是显示
  reminderClosed: 24, // 关闭后24小时后重复显示
  onshow: function(infos){}, // 通知生成回调函数
  onclick: function(infos){}, // 被点击回调函数
  onclose: function(infos){}, // 被关闭回调函数
  newwindow: true, // 新窗口打开
  noclose: false, // 不显示忽略按钮
  no_permanent_hide: true, // 永久关闭按钮
  mobile: false, // 移动设备检测
  api: 2019.09 // api版本
}
